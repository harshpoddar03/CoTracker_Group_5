...
class KubricMovifDataset(CoTrackerDataset):
    def __init__(
        ...
        # try:
        #     index_9603 = self.seq_names.index('9603')
        #     print(f"Index of '9603': {index_9603}")
        # except ValueError:
        #     print("'9603' not found in the sequence names")
    ...
    def getitem_helper(self, index):
        ...
        # print("hey")
        try:
            imageio.v2.imread(os.path.join(rgb_path, img_paths[0]))
        except:
            print(f"Error reading {img_paths[0]}")
            return None, False
        ...
        # print(f"Trajectories1 shape: {traj_2d.shape}")
        ...
        # print(f"Trajectories2 shape: {traj_2d.shape}")
        ...
        # print(f"Trajectories3 shape: {traj_2d.shape}")
